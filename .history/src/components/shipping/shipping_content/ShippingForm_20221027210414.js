          ...
          <div className="xl:w-auto">
            <div className="flex items-center pb-4">
              ...
              <div className="w-[400px]">
                <InputShipping
                  className="border-[#cccccc] rounded border-solid border-[1px] w-[400px] items-center h-[38px] px-2 focus:border-[##008641] focus:shadow-[0_0_0_1px_##008641]"
                  control={control}
                  name="name"
            ...
            <div className="flex items-center pb-4">
              ...
              <div className="w-[400px]">
                <InputShipping
                  className="border-[#cccccc] rounded border-solid border-[1px] w-[400px] items-center h-[38px] px-2 focus:border-[#2684FF] focus:shadow-[0_0_0_1px_##008641]"
                  control={control}
                  name="phoneNumber"
