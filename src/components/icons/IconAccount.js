...
const IconAccount = () => {
  ...
  return (
    <>
      ...
      <div
        id="dropdown"
        className="absolute z-50 hidden transition-all bg-white divide-y divide-gray-100 rounded shadow peer-hover:flex hover:flex w-44 text-text1 dark:bg-gray-700 top-14 right-[6.5rem] translate-y-1/6"
      >
        <ul
